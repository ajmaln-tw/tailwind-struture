...
const Interactivity = () => {
    return <div>Interactivity
        <p>hover</p>
        <button className="bg-black text-white py-3 px-5 rounded-lg
        hover:bg-white hover:text-black"> hit me</button>
        <p>focus</p>
        <button className="bg-red-500 text-white py-3 px-5 rounded-lg
        focus:bg-red-600"> hit me</button>

        <p>Active</p>
        <button className="bg-yellow-400 text-black py-3 px-5 rounded-lg
        active:bg-red-600"> hit me</button>
        <div className="py-2">
            <p> group</p>
            <a href="/" className="group block max-w-sx mx-auto rounded-lg p-6 bg-white shadow-lg  space-y-3
            hover:bg-sky-500">
                <h3 className="group-hover:text-white">Title</h3>
                <p className="group-hover:text-white">Content</p>
            </a>
        </div>
        < br />
        <div id="top-content"> </div>
        <button className="bg-black text-white py-3 px-5 rounded-lg
        hover:bg-white hover:text-black cursor-wait"> Save </button>
        ...
        <a href="#top-content">Go to Top</a>
    </div>;
};
